...
library(Seurat)
library(tidyverse)
buildnetwork <- function(frame, matchingresult,status){
  from <- NULL
  to <- NULL
...
save(result_HFHS_list, result_Fruc_list, file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/Su_SI_result_Orig_Liver.rda")
...
currentset <- c("Set1","Set2")
network_Fruc_SI <- buildnetwork(frame_SI,Fructose_match_SI,"Fructose")
network_Fruc_SI$treatment <- "Fruc"
network_HFHS_SI <- buildnetwork(frame_SI,HFHS_match_SI,"HFHS")
network_HFHS_SI$treatment <- "HFHS"
write.csv(network_Fruc_SI,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SI_test_Liver_Fruc.csv",quote = F, row.names = F)
write.csv(network_HFHS_SI,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SI_test_Liver_HFHS.csv",quote = F, row.names = F)
...
write.csv(network_SI,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SI_test_Liver.csv",quote = F, row.names = F)
save(ligand_target_frame_Fruc,ligand_target_frame_HFHS, file = "/Users/Tsai_Lab/Desktop/Box Sync/Mergeomics-master/Network_Liver_LR_SI.rda")
...
save(result_HFHS_list, result_Fruc_list, file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/Su_SVF_result_Orig_Liver.rda")
...
network_Fruc_SVF <- buildnetwork(frame_SVF,Fructose_match_SVF,"Fructose")
network_Fruc_SVF$treatment <- "Fruc"
network_HFHS_SVF <- buildnetwork(frame_SVF,HFHS_match_SVF,"HFHS")
network_HFHS_SVF$treatment <- "HFHS"
write.csv(network_Fruc_SVF ,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SVF_test_Liver_Fruc.csv",quote = F, row.names = F)
write.csv(network_HFHS_SVF,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SVF_test_Liver_HFHS.csv",quote = F, row.names = F)
...
write.csv(network_SVF,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SVF_test_Liver.csv",quote = F, row.names = F)

save(ligand_target_frame_Fruc,ligand_target_frame_HFHS, file = "/Users/Tsai_Lab/Desktop/Box Sync/Mergeomics-master/Network_Liver_LR_SVF.rda")
...
save(result_HFHS_list, result_Fruc_list, file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/Su_Hyp_result_Orig_Liver.rda")
...
network_Fruc_HYP <- buildnetwork(frame_HYP,Fructose_match_HYP,"Fructose")
network_Fruc_HYP$treatment <- "Fruc"
network_HFHS_HYP <- buildnetwork(frame_HYP,HFHS_match_HYP,"HFHS")
network_HFHS_HYP$treatment <- "HFHS"
write.csv(network_Fruc_HYP ,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_HYP_test_Liver_Fruc.csv",quote = F, row.names = F)
write.csv(network_HFHS_HYP,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_HYP_test_Liver_HFHS.csv",quote = F, row.names = F)
...
write.csv(network_HYP,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_HYP_test_Liver.csv",quote = F, row.names = F)
save(ligand_target_frame_Fruc,ligand_target_frame_HFHS, file = "/Users/Tsai_Lab/Desktop/Box Sync/Mergeomics-master/Network_Liver_LR_HYP.rda")
...
save(result_HFHS_list, result_Fruc_list, file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/Su_Liver_result_Orig_Liver.rda")
...
network_Fruc_Liver <- buildnetwork(frame_Liver,Fructose_match_Liver,"Fructose")
network_Fruc_Liver$treatment <- "Fruc"
network_HFHS_Liver <- buildnetwork(frame_Liver,HFHS_match_Liver,"HFHS")
network_HFHS_Liver$treatment <- "HFHS"
write.csv(network_Fruc_Liver,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_Liver_test_Liver_Fruc.csv",quote = F, row.names = F)
write.csv(network_HFHS_Liver,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_Liver_test_Liver_HFHS.csv",quote = F, row.names = F)
...
write.csv(network_Liver,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_Liver_test_Liver.csv",quote = F, row.names = F)
save(ligand_target_frame_Fruc,ligand_target_frame_HFHS, file = "/Users/Tsai_Lab/Desktop/Box Sync/Mergeomics-master/Network_Liver_LR_Liver.rda")
...
combined_network_fruc <- rbind.data.frame(network_Fruc_SI,network_Fruc_HYP,network_Fruc_SVF, network_Fruc_Liver)
combined_network_HFHS <- rbind.data.frame(network_HFHS_SI,network_HFHS_HYP,network_HFHS_SVF, network_HFHS_Liver)
write.csv(combined_network_fruc,file = "/Users/Tsai_Lab/Desktop/Box Sync/Yang_Lab_doc_share/projects/Fructose_single_cell/combined_Fruc_Liver_network_final_ver2.csv",quote = F)
write.csv(combined_network_HFHS,file = "/Users/Tsai_Lab/Desktop/Box Sync/Yang_Lab_doc_share/projects/Fructose_single_cell/combined_HFHS_Liver_network_final_ver2.csv", quote = F)
