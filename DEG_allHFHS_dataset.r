...
save(DEGlist,DEGlist_up,DEGlist_down,Humaninelist,Khklist,Aldoblist,Glut5list,Fcgrtlist,Pu1list,DEGfulltable_multiple,DEGfulltable_single,DEGfulltableind,foldchangemerge_final,pvaluemerge_final,topDEG,file = "HumaninefoldHFHS.rda")
...
save(result,result_final, file= "pathwayinfo_HFHS.rda")
write.csv(finalframe,file = "cross_batch_DEG_FDR_Doug_HFHS.csv")
...
save(DEGlist,DEGlist_up,DEGlist_down,Humaninelist,Khklist,Aldoblist,Glut5list,Fcgrtlist,Pu1list,DEGfulltable_multiple,DEGfulltable_single,DEGfulltableind,foldchangemerge_final,pvaluemerge_final,topDEG,file = "HumaninefoldHFHS_subset.rda")
...
result_final <- result %>% group_by(set_celltype) %>% top_n(n = 5, wt = FDR)
save(result,result_final, file= "pathwayinfo_HFHS_subset.rda")
write.csv(finalframe,file = "cross_batch_DEG_FDR_Doug_HFHS_subset.csv")
