...
save(result_HFHS_list, result_Fruc_list, file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/Su_Liver_result_Orig_SVF.rda")
...
load("/Users/Tsai_Lab/Desktop/Box Sync/Fructose/SVF_combined/Humaninefold.rda")
...
load("/Users/Tsai_Lab/Desktop/Box Sync/Fructose/SVF_combined/HumaninefoldHFHS.rda")
...
write.csv(network_Fruc_Liver,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_Liver_test_SVF_Fruc.csv",quote = F, row.names = F)
write.csv(network_HFHS_Liver,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_Liver_test_SVF_HFHS.csv",quote = F, row.names = F)
...
write.csv(network_Liver,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_Liver_test_SVF.csv",quote = F, row.names = F)
save(ligand_target_frame_Fruc,ligand_target_frame_HFHS, file = "/Users/Tsai_Lab/Desktop/Box Sync/Mergeomics-master/Network_SVF_LR_Liver.rda")
...
save(result_HFHS_list, result_Fruc_list, file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/Su_SI_result_Orig_SVF.rda")
...
write.csv(network_Fruc_SI,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SI_test_SVF_Fruc.csv",quote = F, row.names = F)
write.csv(network_HFHS_SI,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SI_test_SVF_HFHS.csv",quote = F, row.names = F)
...
write.csv(network_SI,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SI_test_SVF.csv",quote = F, row.names = F)

save(ligand_target_frame_Fruc,ligand_target_frame_HFHS, file = "/Users/Tsai_Lab/Desktop/Box Sync/Mergeomics-master/Network_SVF_LR_SI.rda")
...
save(result_HFHS_list, result_Fruc_list, file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/Su_Hyp_result_Orig_SVF.rda")
...
write.csv(network_Fruc_HYP ,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_HYP_test_SVF_Fruc.csv",quote = F, row.names = F)
write.csv(network_HFHS_HYP,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_HYP_test_SVF_HFHS.csv",quote = F, row.names = F)
...
write.csv(network_HYP,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_HYP_test_SVF.csv",quote = F, row.names = F)

save(ligand_target_frame_Fruc,ligand_target_frame_HFHS, file = "/Users/Tsai_Lab/Desktop/Box Sync/Mergeomics-master/Network_SVF_LR_HYP.rda")
...
save(result_HFHS_list, result_Fruc_list, file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/Su_SVF_result_Orig_SVF.rda")
...
write.csv(network_Fruc_SVF ,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SVF_test_SVF_Fruc.csv",quote = F, row.names = F)
write.csv(network_HFHS_SVF,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SVF_test_SVF_HFHS.csv",quote = F, row.names = F)
...
write.csv(network_SVF,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SVF_test_SVF.csv",quote = F, row.names = F)

save(ligand_target_frame_Fruc,ligand_target_frame_HFHS, file = "/Users/Tsai_Lab/Desktop/Box Sync/Mergeomics-master/Network_SVF_LR_SVF.rda")
...
combined_network_fruc <- rbind.data.frame(network_Fruc_Liver,network_Fruc_HYP,network_Fruc_SI, network_Fruc_SVF)
combined_network_HFHS <- rbind.data.frame(network_HFHS_Liver,network_HFHS_HYP,network_HFHS_SI, network_HFHS_SVF)
write.csv(combined_network_fruc,file = "/Users/Tsai_Lab/Desktop/Box Sync/Yang_Lab_doc_share/projects/Fructose_single_cell/combined_Fruc_SVF_network_final_ver2.csv",quote = F)
write.csv(combined_network_HFHS,file = "/Users/Tsai_Lab/Desktop/Box Sync/Yang_Lab_doc_share/projects/Fructose_single_cell/combined_HFHS_SVF_network_final_ver2.csv", quote = F)
