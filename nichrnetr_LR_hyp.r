...
#Define sender from hypothalamus
...
currentset <- "Set1"
#sender_celltypes = c("General neurons","Glutamatergic neurons","GABAergic neurons")
...
#                                                  c("0" = "lowUMI1","1" = "lowUMI1","2" = "lowUMI1","3" = "Cartpt_Gabaergic", 
#                                                    "4" = "lowUMI1","5" = "Grp_Glutaminergic","6" = "Prok2_Gabaergic","7" = "Sst_Agrp_Gabaergic",
#                                                    "8" = "Pomc_Glutaminergic","9" = "Sst_Bcl11b_Gabaergic","10" = "Prlr_Glutaminergic","11" = "Sim1_Glutaminergic","12" = "Ghrh_Gabaergic",
#                                                    "13" = "Crabp1_Gabaergic","14" = "Trh_Gabaergic","15" = "Tac1_Glutaminergic","16" = "Lhx1_Gabaergic",
#                                                    "17" = "Lhx6_Gabaergic","18" = "Slc18a2_Prph","19" = "Ctss_Gabaergic","20" = "Ndnf_Glutaminergic"))
#DimPlot(dropEST.combined.filtered, group.by = "celltype",reduction="tsne",label = T)
#currentset <- "Set1"
#sender_celltypes = names(which(table(dropEST.combined.filtered$celltype) > 20))
#seuratObj <- dropEST.combined.filtered
...
#dropEST.combined.filtered[["celltype"]] = revalue(dropEST.combined.filtered@meta.data$integrated_snn_res.0.5,
#                                                  c("0" = "General Intestinal epi","1" = "Mature proximal_Gsta1","3" = "General Intestinal epi","2" = "Mature distal_Krt20", "4" = "T cells","7" = "Goblet", "5" = "Mature distal_Ifit1",
#                                                    "6" = "Mature distal_Fabp6","8" = "Mature Prox_Fth1","9" = "Mature distal_Pmp22","10" = "Proliferative cells","11" = "I cells","12" = "S cells","13" = "Dendritic cells","14" = "Tuft","15" = "B cell_Igj"))
...
save(result_HFHS_list, result_Fruc_list, file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/Su_SI_LR_result_Orig_hyp.rda")
...
load("/Users/Tsai_Lab/Desktop/Box Sync/Fructose/HYP_combined/Humaninefold.rda")
...
#Matched receptor selection 

c("Avp","Oxt","Sst","Calr","Agrn","Gpi1","Calr") %in% DEGlist_up$`Set1_Gabaergic neurons`
c("Avp","Oxt","Sst","Calr","Agrn","Gpi1","Calr") %in% DEGlist_up$`Set1_Glutamatergic neurons`
c("Avp","Oxt","Sst","Calr","Agrn","Gpi1","Calr") %in% DEGlist_down$`Set1_Gabaergic neurons`
c("Avp","Oxt","Sst","Calr","Agrn","Gpi1","Calr") %in% DEGlist_down$`Set1_Glutamatergic neurons`


load("/Users/Tsai_Lab/Desktop/Box Sync/Fructose/HYP_combined/HumaninefoldHFHS.rda")
...
write.csv(network_Fruc_SI,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SI_test_hyp_LR_Fruc.csv",quote = F, row.names = F)
write.csv(network_HFHS_SI,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SI_test_hyp_LR_HFHS.csv",quote = F, row.names = F)
...
write.csv(network_SI,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SI_test_hyp_LR.csv",quote = F, row.names = F)

save(ligand_target_frame_Fruc,ligand_target_frame_HFHS, file = "/Users/Tsai_Lab/Desktop/Box Sync/Mergeomics-master/Network_Hyp_LR_SI.rda")
...
save(result_HFHS_list, result_Fruc_list, file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/Su_Liver_LR_result_Orig_hyp.rda")
...
write.csv(network_Fruc_Liver,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_Liver_test_hyp_LR_Fruc.csv",quote = F, row.names = F)
write.csv(network_HFHS_Liver,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_Liver_test_hyp_LR_HFHS.csv",quote = F, row.names = F)
...
write.csv(network_Liver,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_Liver_test_Hyp_LR.csv",quote = F, row.names = F)

save(ligand_target_frame_Fruc,ligand_target_frame_HFHS, file = "/Users/Tsai_Lab/Desktop/Box Sync/Mergeomics-master/Network_Hyp_LR_Liver.rda")
...
save(result_HFHS_list, result_Fruc_list, file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/Su_SVF_LR_result_Orig_hyp.rda")
...
write.csv(network_Fruc_SVF ,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SVF_test_hyp_LR_Fruc.csv",quote = F, row.names = F)
write.csv(network_HFHS_SVF,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SVF_test_hyp_LR_HFHS.csv",quote = F, row.names = F)
...
write.csv(network_SVF,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_SVF_test_Hyp_LR.csv",quote = F, row.names = F)

save(ligand_target_frame_Fruc,ligand_target_frame_HFHS, file = "/Users/Tsai_Lab/Desktop/Box Sync/Mergeomics-master/Network_Hyp_LR_SVF.rda")
...
save(result_HFHS_list, result_Fruc_list, file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/Su_Hyp_LR_result_Orig_hyp.rda")
...
write.csv(network_Fruc_HYP ,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_HYP_test_Hyp_Fruc.csv",quote = F, row.names = F)
write.csv(network_HFHS_HYP,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_HYP_test_Hyp_HFHS.csv",quote = F, row.names = F)
...
write.csv(network_HYP,file = "/Users/Tsai_Lab/Desktop/Box Sync/Fructose/network_HYP_test_Hyp.csv",quote = F, row.names = F)
save(ligand_target_frame_Fruc,ligand_target_frame_HFHS, file = "/Users/Tsai_Lab/Desktop/Box Sync/Mergeomics-master/Network_Hyp_LR_Hyp.rda")
...
combined_network_fruc <- rbind.data.frame(network_Fruc_Liver,network_Fruc_SI,network_Fruc_SVF,network_Fruc_HYP)
combined_network_HFHS <- rbind.data.frame(network_HFHS_Liver,network_HFHS_SI,network_HFHS_SVF,network_HFHS_HYP)
write.csv(combined_network_fruc,file = "/Users/Tsai_Lab/Desktop/Box Sync/Yang_Lab_doc_share/projects/Fructose_single_cell/combined_Fruc_LR_hypnetwork_final_ver2.csv",quote = F)
write.csv(combined_network_HFHS,file = "/Users/Tsai_Lab/Desktop/Box Sync/Yang_Lab_doc_share/projects/Fructose_single_cell/combined_HFHS_LR_hypnetwork_final_ver2.csv", quote = F)
