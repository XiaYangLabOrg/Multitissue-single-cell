...
#DimPlot(dropEST.combined.filtered,group.by = "data.diseasestatus",reduction = "umap",label = F, cols = c("Control"="darkslategray","Fruc" = "cyan3","HFHS" = "hotpink"))+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=24))+ guides(colour = guide_legend(override.aes = list(size=5)))+ggtitle("")
SI_Fig1 <- DimPlot(dropEST.combined.filtered,group.by = "data.diseasestatus",pt.size = 0.00000001,
...
#DimPlot(dropEST.combined.filtered,group.by = "samplename",reduction = "umap",label = F)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=24))+ guides(colour = guide_legend(override.aes = list(size=5)))+ggtitle("")
SI_Sup1 <- DimPlot(dropEST.combined.filtered,group.by = "samplename",reduction = "umap",label = F)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=14))+ guides(colour = guide_legend(override.aes = list(size=4)))+ggtitle("")
SI_Sup6 <- DimPlot(dropEST.combined.filtered,group.by = "celltype",reduction = "umap",label = T, repel = T, label.size = 8)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=14))+ guides(colour = guide_legend(override.aes = list(size=8)))+ggtitle("")
...
#DimPlot(dropEST.combined.filtered,group.by = "data.diseasestatus",reduction = "umap",label = F, cols = c("Control"="darkslategray","Fruc" = "cyan3","HFHS" = "hotpink"))+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=24))+ guides(colour = guide_legend(override.aes = list(size=5)))+ggtitle("")
SVF_Fig1 <- DimPlot(dropEST.combined.filtered,group.by = "data.diseasestatus",pt.size = 0.01,reduction = "umap",label = F, cols = c("Control"="darkslategray","Fruc" = "cyan3","HFHS" = "hotpink"))+ 
  theme(axis.text = element_text(size = 14),axis.title = element_text(size = 16),legend.text=element_text(size=14))+ guides(colour = guide_legend(override.aes = list(size=3)))+ggtitle("")
#DimPlot(dropEST.combined.filtered,group.by = "samplename",reduction = "umap",label = F)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=24))+ guides(colour = guide_legend(override.aes = list(size=5)))+ggtitle("")
SVF_Sup1 <- DimPlot(dropEST.combined.filtered,group.by = "samplename",reduction = "umap",label = F)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=14))+ guides(colour = guide_legend(override.aes = list(size=4)))+ggtitle("")
SVF_Sup6 <- DimPlot(dropEST.combined.filtered,group.by = "celltype",reduction = "umap",label = T, repel = T, label.size = 8)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=14))+ guides(colour = guide_legend(override.aes = list(size=8)))+ggtitle("")
...
#DimPlot(dropEST.combined.filtered,group.by = "data.diseasestatus",reduction = "umap",label = F, cols = c("Control"="darkslategray","Fruc" = "cyan3","HFHS" = "hotpink"))+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=24))+ guides(colour = guide_legend(override.aes = list(size=5)))+ggtitle("")
Liver_Fig1 <- DimPlot(dropEST.combined.filtered,group.by = "data.diseasestatus",pt.size = 0.01,reduction = "umap",label = F, cols = c("Control"="darkslategray","Fruc" = "cyan3","HFHS" = "hotpink"))+ 
  theme(axis.text = element_text(size = 14),axis.title = element_text(size = 16),legend.text=element_text(size=14))+ guides(colour = guide_legend(override.aes = list(size=3)))+ggtitle("")
#DimPlot(dropEST.combined.filtered,group.by = "samplename",reduction = "umap",label = F)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=24))+ guides(colour = guide_legend(override.aes = list(size=5)))+ggtitle("")
Liver_Sup1 <- DimPlot(dropEST.combined.filtered,group.by = "samplename",reduction = "umap",label = F)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=10))+ guides(colour = guide_legend(override.aes = list(size=4)))+ggtitle("")
Liver_Sup6 <- DimPlot(dropEST.combined.filtered,group.by = "celltype",reduction = "umap",label = T, repel = T, label.size = 8)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=14))+ guides(colour = guide_legend(override.aes = list(size=8)))+ggtitle("")
...
#DimPlot(dropEST.combined.filtered,group.by = "data.diseasestatus",reduction = "umap",label = F, cols = c("Control"="darkslategray","Fruc" = "cyan3","HFHS" = "hotpink"))+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=24))+ guides(colour = guide_legend(override.aes = list(size=5)))+ggtitle("")
Hyp_Fig1 <- DimPlot(dropEST.combined.filtered,group.by = "data.diseasestatus",pt.size = 0.01,reduction = "umap",label = F, cols = c("Control"="darkslategray","Fruc" = "cyan3","HFHS" = "hotpink"))+ 
  theme(axis.text = element_text(size = 14),axis.title = element_text(size = 16),legend.text=element_text(size=14))+ guides(colour = guide_legend(override.aes = list(size=3)))+ggtitle("")
#DimPlot(dropEST.combined.filtered,group.by = "samplename",reduction = "umap",label = F)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=24))+ guides(colour = guide_legend(override.aes = list(size=5)))+ggtitle("")
Hyp_Sup1 <- DimPlot(dropEST.combined.filtered,group.by = "samplename",reduction = "umap",label = F)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=14))+ guides(colour = guide_legend(override.aes = list(size=4)))+ggtitle("")
Hyp_Sup6 <-DimPlot(dropEST.combined.filtered,group.by = "celltype",reduction = "umap",label = T, repel = T, label.size = 6)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=14))+ guides(colour = guide_legend(override.aes = list(size=8)))+ggtitle("")
...
DimPlot(dropEST.combined.filtered,group.by = "data.diseasestatus",reduction = "umap",pt.size = 0.01,label = F, cols = c("Control"="darkslategray","Fruc" = "cyan3","HFHS" = "hotpink"))+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=24))+ guides(colour = guide_legend(override.aes = list(size=5)))+ggtitle("")
Hypneuron_Fig1 <- DimPlot(dropEST.combined.filtered,group.by = "data.diseasestatus",reduction = "umap",label = F, cols = c("Control"="darkslategray","Fruc" = "cyan3","HFHS" = "hotpink"))+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=24))+ guides(colour = guide_legend(override.aes = list(size=5)))+ggtitle("")
DimPlot(dropEST.combined.filtered,group.by = "samplename",reduction = "umap",label = F)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=24))+ guides(colour = guide_legend(override.aes = list(size=5)))+ggtitle("")
Hypneuron_Sup1 <- DimPlot(dropEST.combined.filtered,group.by = "samplename",reduction = "umap",label = F)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=24))+ guides(colour = guide_legend(override.aes = list(size=5)))+ggtitle("")
Hypneuron_Sup6 <- DimPlot(dropEST.combined.filtered,group.by = "celltype",reduction = "umap",label = T, repel = T, label.size = 8)+ theme(axis.text = element_text(size = 24),axis.title = element_text(size = 28),legend.text=element_text(size=14))+ guides(colour = guide_legend(override.aes = list(size=8)))+ggtitle("")
...
#pdf("/Users/Tsai_Lab/Desktop/Box Sync/Yang_Lab_doc_share/projects/Fructose_single_cell/Combined_figure1_combined.pdf",width = 10, height = 10)
